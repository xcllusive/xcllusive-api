...
export const list = async (req, res, next) => {
  ...
  const options = {
    attributes: [
      'id', 'businessName', 'firstNameV', 'lastNameV', 'address1', 'industry', 'listedPrice', 'description', 'stageId', 'productId', 'industryId', 'suburb', 'state', 'postCode', 'typeId', 'notifyOwner', 'vendorEmail', 'company_id', 'vendorPhone1', 'vendorPhone2', 'vendorPhone3', 'ctcStageId', 'ccEmail'
    ],
    include: [
...
export const updateListingAgent = async (req, res, next) => {
  const { listingAgentId, listingAgentCtcId, company } = req.body
...
export const sendEmailToCtcBusiness = async (req, res, next) => {
  const { values, buyer, business } = req.body
...
export const addIssueToBusiness = async (req, res, next) => {
  const { issueId, business } = req.body
...
export const removeIssueFromBusiness = async (req, res, next) => {
  const { issueId, businessId } = req.body
...
export const getBusinessesAdvancedSearch = async (req, res, next) => {
  const { limit, businessName, firstNameV, lastNameV, vendorEmail, vendorPhone1, suburb, postCode, businessType, businessProduct, industry, priceFrom, priceTo, brokerAccountName, xcllusiveAnalyst, ctcAnalyst, sourceId, stageId, ctcStageId, ctcSourceId, company, dateFrom, dateTo } = req.query
